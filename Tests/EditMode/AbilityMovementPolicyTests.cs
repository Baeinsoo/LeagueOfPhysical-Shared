...
namespace LOP.Tests
{
    ...
    {
        private static AbilityActivation MakeActive(float su, float ac, float re, bool jump)
            => new AbilityActivation(3, AbilityPhase.Startup, 10, 100, 200, null,
        ...
        private static Entity EntityWith(AbilityActivation? active)
        {
            var e = new Entity("e1");
        ...
        [Test]
        public void GetMovementMultiplier_NoAbilityActivation_ReturnsOne()
        {
        ...
        public void GetMovementMultiplier_PicksPhaseScale_ByBoundaryTick()
        {
            ...
            var e = EntityWith(new AbilityActivation(3, AbilityPhase.Startup, 10, 100, 200, null,
        ...
        {
            var blocking = EntityWith(new AbilityActivation(3, AbilityPhase.Active, 0, 5, 10, null,
            ...
            var nonBlocking = EntityWith(new AbilityActivation(3, AbilityPhase.Active, 0, 5, 10, null,
                                                           new AbilityEffect[0]));
            Assert.IsFalse(AbilitySystem.IsJumpBlocked(nonBlocking, 3), "플래그 off");
        }

        [Test]
        public void TryActivate_CopiesMovePolicy_IntoAbilityActivation()
        {
