...
namespace LOP.Tests
{
    public class InputCommandTests
    {
        ...
        public void ToString_ShowsEveryField_InLogShape()
        {
            ...
            Assert.That(cmd.ToString(), Is.EqualTo("h=0.50 v=-1.00 jump=True ability=7 posture=0.00 glide=False posing=False dash=False aim=(0.0,0.0) draw=False release=False"));
        }
    }
}
