...
namespace LOP.Tests
{
    public class FlappyMoveSystemTests
    {
        ...
        public void 중력이_세로_속도를_깎는다()
        {
            ...
            new FlappyMoveSystem(Config()).Tick(bird, 0.1f, dashing: false, finished: false);
        ...
        public void 플랩은_낙하를_지우고_늘_같은_높이로_띄운다()
        {
            ...
            new FlappyMoveSystem(Config()).Tick(falling, 0.1f, dashing: false, finished: false);
            new FlappyMoveSystem(Config()).Tick(rising, 0.1f, dashing: false, finished: false);
